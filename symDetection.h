...
public:
	...
	*/
	...
	// Qualifier:
	// Parameter: Point p1	直线第一点
	// Parameter: Point p2	直线第二点
	//************************************
	...
	// Qualifier:
	// Parameter: Point p_l		直线左边的点
	// Parameter: Point p_r		直线右边的点
	// Parameter: double k		直线斜率
	// Parameter: double b		直线截距
	//************************************
	...
	// Access:    public 
	// Returns:   bool		两段距离差小于阈值则true，反之则false
	// Qualifier:
	// Parameter: double dis1	第一段距离
	// Parameter: double dis2	第二段距离
	//************************************
